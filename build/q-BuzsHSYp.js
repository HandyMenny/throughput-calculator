...
import{ab as l,aa as v}from"./q-Dyu2sCja.js";import{$ as i,l as p,P as _,p as u,c,q as n,_ as s,E as m,U as d}from"./q-_JLpC6VS.js";const x=a=>{const[e,o]=i();e.positionX.value&&(e.value.value=l(a.pageX-e.positionX.value,e.min.value,e.max.value)),o.value=!0},f=a=>{const[e,o]=i();e.positionX.value&&o.value&&(e.value.value=l(a.pageX-e.positionX.value,e.min.value,e.max.value))},g=a=>{const[e,o]=i();e.positionX.value&&o.value&&(e.value.value=l(a.pageX-e.positionX.value,e.min.value,e.max.value)),o.value=!1},w=a=>{const e=p(!1),o=_(v),r=n(()=>s(()=>Promise.resolve().then(()=>t),void 0),"s_D8WvLnKHNUw",[o,e]);return u("mousemove",n(()=>s(()=>Promise.resolve().then(()=>t),void 0),"s_kd2cGCnxV3Y",[o,e])),u("mouseup",n(()=>s(()=>Promise.resolve().then(()=>t),void 0),"s_mV7WaK4570w",[o,e])),c("div",{style:`
        width: 20px;
        height: 20px;
        border-radius: 20px;
